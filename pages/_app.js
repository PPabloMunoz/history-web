...
function MyApp({ Component, pageProps }) {
  ...
  return (
    <div
      className={
        dark ? 'dark bg-[#181818] min-h-screen' : 'bg-white min-h-screen'
      }
    >
      <Head>
      ...
      <label className='swap swap-rotate absolute top-0 right-0 p-5'>
        <input type='checkbox' onClick={() => updateDark(!dark)} />
        {/* <!-- moon icon --> */}
        <svg
